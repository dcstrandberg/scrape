'''
TODOS: 
- Add proxy list that works
- Switch proxy every request
= Add random wait to each request
- Add search term list
- Create container function to cycle through terms
...
def get_data(pageNo,q):  
    ...
    r = requests.get("https://www.amazon.com/s?k=" + keyword + "&page=" + str(pageNo), headers=headers)#, proxies=proxies)
    content = r.content
    soup = BeautifulSoup(content, features="lxml")
    #print(soup.encode('utf-8')) # uncomment this in case there is some non UTF-8 character in the content and
                                 # you get error
	
    for d in soup.findAll('div', attrs={'class':'sg-col-4-of-24 sg-col-4-of-12 sg-col-4-of-36 s-result-item s-asin sg-col-4-of-28 sg-col-4-of-16 AdHolder sg-col sg-col-4-of-20 sg-col-4-of-32'}):
...
if __name__ == "__main__":
    ...
    print(df)
    df.to_csv('./amazon_data/' + keyword + '_products.csv', index=False, encoding='utf-8')
